...
Do not rely on a single source for Global News. For each of the 10 outlets below, search "[outlet name] top story today" and identify their top 3 stories in order. Then score every candidate story using this weighted system:
...
Maximum possible score = 60 (10 outlets × 6 points each).
