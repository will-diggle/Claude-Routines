...
GRAMMAR_RULE_A2_BY_LANG: dict[str, str] = {
    "fr": (
        ...
        "AND MUST include at least one subordinate clause somewhere in the article. Writing "
    ...
    "en": (
        ...
        "REQUIRED, not optional: this article MUST actually use the past continuous at "
        "least once AND MUST include at least one subordinate clause somewhere in the "
        "article. Writing only what A1 would write is a failure at this level, even if "
        "nothing is technically wrong — A2 is defined by USING these features, not merely "
        "being allowed to.\n"
    ...
    "de": (
        ...
        "somewhere in the article. Writing only what A1 would write is a failure at this "
    ...
    "it": (
        ...
        "once AND MUST include at least one subordinate clause somewhere in the article. "
