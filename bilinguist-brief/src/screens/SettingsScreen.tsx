...
function FlagCircle({ code, size = 28 }: { code: string; size?: number }) {
  const r = size / 2;
  return (
    <RNView style={{ width: size, height: size, borderRadius: r, overflow: 'hidden' }}>
    ...
    case 'fr':
      return (
        <RNView style={{ flex: 1, flexDirection: 'row' }}>
          <RNView style={{ flex: 1, backgroundColor: '#002395' }} />
          <RNView style={{ flex: 1, backgroundColor: '#FFFFFF' }} />
          <RNView style={{ flex: 1, backgroundColor: '#ED2939' }} />
        </RNView>
      );
    case 'de':
      return (
        <RNView style={{ flex: 1, flexDirection: 'column' }}>
          <RNView style={{ flex: 1, backgroundColor: '#000000' }} />
          <RNView style={{ flex: 1, backgroundColor: '#DD0000' }} />
          <RNView style={{ flex: 1, backgroundColor: '#FFCE00' }} />
        </RNView>
      );
    case 'it':
      return (
        <RNView style={{ flex: 1, flexDirection: 'row' }}>
          <RNView style={{ flex: 1, backgroundColor: '#009246' }} />
          <RNView style={{ flex: 1, backgroundColor: '#FFFFFF' }} />
          <RNView style={{ flex: 1, backgroundColor: '#CE2B37' }} />
        </RNView>
      );
    case 'es':
      return (
        <RNView style={{ flex: 1, flexDirection: 'column' }}>
          <RNView style={{ flex: 1, backgroundColor: '#AA151B' }} />
          <RNView style={{ flex: 2, backgroundColor: '#F1BF00' }} />
          <RNView style={{ flex: 1, backgroundColor: '#AA151B' }} />
        </RNView>
      );
    case 'hu':
      return (
        <RNView style={{ flex: 1, flexDirection: 'column' }}>
          <RNView style={{ flex: 1, backgroundColor: '#CE2939' }} />
          <RNView style={{ flex: 1, backgroundColor: '#FFFFFF' }} />
          <RNView style={{ flex: 1, backgroundColor: '#477050' }} />
        </RNView>
      );
    case 'sv':
      return (
        <RNView style={{ flex: 1, backgroundColor: '#006AA7' }}>
          <RNView style={{ position: 'absolute', top: size * 0.375, left: 0, right: 0, height: size * 0.25, backgroundColor: '#FECC02' }} />
          <RNView style={{ position: 'absolute', top: 0, bottom: 0, left: size * 0.3, width: size * 0.25, backgroundColor: '#FECC02' }} />
        </RNView>
      );
    case 'tr':
      return (
        <RNView style={{ flex: 1, backgroundColor: '#E30A17' }}>
          <RNView style={{ position: 'absolute', width: size * 0.45, height: size * 0.45, borderRadius: size * 0.225, backgroundColor: '#FFFFFF', top: size * 0.275, left: size * 0.12 }} />
          <RNView style={{ position: 'absolute', width: size * 0.4, height: size * 0.4, borderRadius: size * 0.2, backgroundColor: '#E30A17', top: size * 0.3, left: size * 0.22 }} />
        </RNView>
      );
    case 'en':
    default:
      return (
        <RNView style={{ flex: 1, backgroundColor: '#012169' }}>
          <RNView style={{ position: 'absolute', top: size * 0.375, left: 0, right: 0, height: size * 0.25, backgroundColor: '#FFFFFF' }} />
          <RNView style={{ position: 'absolute', top: 0, bottom: 0, left: size * 0.375, width: size * 0.25, backgroundColor: '#FFFFFF' }} />
          <RNView style={{ position: 'absolute', top: size * 0.425, left: 0, right: 0, height: size * 0.15, backgroundColor: '#C8102E' }} />
          <RNView style={{ position: 'absolute', top: 0, bottom: 0, left: size * 0.425, width: size * 0.15, backgroundColor: '#C8102E' }} />
        </RNView>
      );
  }
}
