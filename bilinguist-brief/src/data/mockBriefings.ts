...
const ARTICLES: Record<LanguageCode, Record<LevelBucket, BriefingArticle[]>> = {
  ...
  ar: {
    A1: [
      ...
      {
        genre: 'Good News',
        headline: 'علماء يصنعون دواءً جديداً',
        body: 'صنع علماء دواءً جديداً. هذا الدواء يساعد الناس. الأطباء سعداء بهذا الاكتشاف. يريدون إعطاء الدواء لكثير من الناس.',
      },
      {
        genre: 'Sport',
        headline: 'الفريق يفوز بالمباراة',
        body: 'فاز الفريق بالمباراة الكبيرة. سجّل اللاعبون ثلاثة أهداف. الجمهور سعيد جداً. ذهب اللاعبون إلى المنزل فرحين.',
      },
      {
        genre: 'Politics',
        headline: 'الرئيس يتحدث عن الاقتصاد',
    ...
    B1: [
      ...
      {
        genre: 'Good News',
        headline: 'لقاح جديد يُظهر نتائج واعدة ضد حمى الضنك',
        body: 'كشفت دراسة طبية نُشرت في مجلة لانسيت أن لقاحاً جديداً لحمى الضنك أظهر فعالية تتجاوز تسعين بالمئة في تجارب المرحلة الثالثة. شمل البحث اثني عشر ألف مشارك في مناطق موبوءة بأمريكا اللاتينية وجنوب شرق آسيا. أعلنت منظمة الصحة العالمية أنها ستُسرّع إجراءات اعتماد اللقاح.',
      },
      {
        genre: 'Sport',
        headline: 'الأرسنال يعزز موقعه في صدارة الدوري بفوز ساحق على تشيلسي',
        body: 'حقق نادي أرسنال فوزاً كبيراً على تشيلسي بثلاثة أهداف مقابل هدف، ليرسّخ مكانته في صدارة الدوري الإنجليزي الممتاز. تألق ساكا بتسجيله هدفين، في حين برز الانسجام التكتيكي للفريق طوال المباراة. يرى المحللون أن هذا الفوز يمنح أرسنال زخماً كبيراً نحو الإقامة الأولى.',
      },
      {
        genre: 'Politics',
        headline: 'البرلمان يناقش مشروع إصلاح قطاع الإسكان',
    ...
    C1: [
      ...
      {
        genre: 'Good News',
        headline: 'لقاح معهد سانغر يُحقق نتائج مفصلية في المرحلة الثالثة',
        body: 'كشف بحث نُشر في دورية لانسيت عن فعالية وقائية تبلغ واحداً وتسعين بالمئة للقاح حمى الضنك المؤتلف الذي طوّره معهد ويلكام سانغر، في تجربة المرحلة الثالثة التي اشتملت على اثني عشر ألف مشارك في أمريكا اللاتينية وجنوب شرق آسيا. أعلنت منظمة الصحة العالمية الشروع في إجراءات التأهيل المسبق المعجَّل.',
      },
      {
        genre: 'Sport',
        headline: 'أرسنال يُسكت منتقديه بتفكيك تشيلسي تكتيكياً',
        body: 'إن كانت ثمة شكوك حول جدارة أرسنال بلقب البطولة، فقد كان الفوز الساحق على تشيلسي بثلاثة أهداف مقابل هدف كفيلاً بتبديدها جميعاً. لم يقتصر الأمر على الفوز؛ إذ فرض الفريق إرادته التكتيكية والبدنية والنفسية على خصم أنفق بسخاء ولا يزال يفتقر إلى البوصلة.',
      },
      {
        genre: 'Politics',
        headline: 'إصلاح التخطيط العمراني: تحرير جريء أم تفكيك ممنهج للرقابة المجتمعية؟',
